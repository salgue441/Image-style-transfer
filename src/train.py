...
from src.data_pipeline.processor import ImageProcessor
from typing import Tuple

def setup_training(base_dir=".", batch_size: int = 1) -> Tuple[ModelConfig, tf.data.Dataset, tf.data.Dataset, int]:
  """
